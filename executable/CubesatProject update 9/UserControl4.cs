...
namespace CubesatProject
{
    ...
    {
        MySqlConnection connection = new MySqlConnection("server=68.119.147.156;port=3308;username=root;password=;database=cubesat_login");//Connection for the database
