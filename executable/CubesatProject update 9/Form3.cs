...
namespace CubesatProject
{
    public partial class settingsPage : Form
    {
        ...
        public settingsPage(Form callingForm, string email)
        {
            ...
            this.currentEmail = email;//Takes email from login to use later
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            if (lightButton.Checked == true)
            {
                ...
                foreach (TabPage cont in mainForm.mainUserControl1.GolfTData.TabPages) //Loop through mainpage tab container
                {
        ...
        public String getCurrentEmail()//Returns the email to whatever calls it
        {
            return currentEmail;
        }
        public void emailChanger(String email) //Changes email from user controls that acess it
        {
        ...
        private void label1_Click_2(object sender, EventArgs e)//Change email made visible
        {
        ...
        private void ChangePassword_Click(object sender, EventArgs e)//Change password made visible
        {
            this.settingsBackgroundPanel.Visible = false;
