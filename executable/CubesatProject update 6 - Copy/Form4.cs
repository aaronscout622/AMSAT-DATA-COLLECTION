...
namespace CubesatProject
{
    ...
    {
        MySqlConnection connection = new MySqlConnection("server=2600:6c50:487f:ca92:7815:45b7:a9a5:b2e6;port=3308;username=root;password=;database=cubesat_login");
        ...
        private void registrationButton_Click(object sender, EventArgs e)
        {
            ...
            String email = emailBox.Text;//Email input
            String password = passBox1.Text;//password input
            String passwordcon = passBox2.Text;//password confirmation input
